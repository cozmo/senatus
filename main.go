...
func main() {
	...
	r.HandleFunc("/topics/{id}/question/{question_id}/vote", sessionMiddleware(h, sessionStore, h.VoteForQuestionHandler)).Methods("GET")
	r.HandleFunc("/topics/{id}/question/{question_id}/unvote", sessionMiddleware(h, sessionStore, h.UnvoteForQuestionHandler)).Methods("GET")
